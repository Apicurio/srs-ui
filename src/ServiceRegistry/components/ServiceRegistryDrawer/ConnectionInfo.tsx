...
export const ConnectionInfo: React.FC<ConnectionInfoProps> = ({
  ...
  const registriesInfo = [
    {
      title: t('srs.connection_content_1'),
      code: `${registryApisUrl}/apis/registry/v2`,
    },
    {
      title: t('srs.connection_content_2'),
      code: `${registryApisUrl}/apis/ccompat/v6`,
    },
    {
      title: t('srs.connection_content_3'),
      ...
      <TextContent className='pf-u-pb-sm'>
        ...
        <Text component={TextVariants.h4} className='pf-u-mt-md'>
          ...
          <Popover
            ...
            bodyContent={<div>{t('srs.oauth_popover_content')}</div>}
          >
            <Button
